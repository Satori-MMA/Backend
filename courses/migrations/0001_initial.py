    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(help_text='Categoria del curso', on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='categories.category', verbose_name='Categoria')),
            ],
            options={
                'verbose_name': 'Curso',
